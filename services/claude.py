...
WEEKLY_MEETING_PARTICIPANTS = ["徐超", "陈俊", "刘斯佳", "李肖然", "孟祥楠", "熊曼佚", "郑文浩", "夏晓童"]
...
本场会议的参会人**只可能是以下 8 人之一**：{names}

执行规则：
1. 纪要中所有人名必须来自上述 8 人。任何不在名单内的人名，**严禁凭空生成**。
2. 逐字稿里的"说话人 1 / 说话人 2 / 说话人 N"是飞书妙记的占位符，**不是真实姓名**。如果无法从上下文锁定身份（自我介绍、被点名、@提及），**保留"说话人 N"原样**，不要瞎猜。
3. 语音识别的近音字优先在名单内匹配：例如"思佳/思家/斯加"→刘斯佳，"祥南/向南"→孟祥楠，"满意/曼意"→熊曼佚，"小然/消然"→李肖然，"小金/小同/晓彤"→夏晓童。
