...
PINLEI_ROSTER = [
    ...
    ("刘亚婷", "摄影摄像品类数据（含数码相机、运动相机、无人机等所有相机/摄像设备）"),
    ("韩尹", "智能数码、探索品类、旧衣品类数据"),
    ("马保辉", "商家招商情况"),
    ("陈俊", "孵化组数据"),
    ("张金宇", "名酒品类数据"),
...
- **所有相机/摄像设备 → 刘亚婷（摄影摄像），严禁归韩尹**：数码相机、运动相机（含大疆 Pocket 等手持云台）、CCD、单反、摄像机、无人机 全部归刘亚婷；韩尹负责的"智能数码"指电子书、VR、投影仪、扫地机器人等探索类数码产品，**不包含任何相机**；即使运动相机是新品/热点话题，也归刘亚婷，不要因为带"数码/新品"就误归韩尹
